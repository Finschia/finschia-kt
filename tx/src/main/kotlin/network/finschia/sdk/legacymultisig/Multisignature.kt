...
fun makeSingleSignedTx(multisigPubkey: AminoPubKey<MultisigThresholdPubkeyValue>, multiSigAccSeq: Int, fee: StdFee, bodyBytes: ByteString, signatures: Map<String, ByteString>, ): cosmos.tx.v1beta1.TxOuterClass.TxRaw {
    val addresses = signatures.toList().map { it.first }
    val prefix = Bech32.decode(addresses[0]).hrp
